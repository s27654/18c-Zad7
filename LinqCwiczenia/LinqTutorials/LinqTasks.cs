...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task1()
        {
            ...
            IEnumerable<Emp> reult2 = from e in Emps where e.Job == "Backened programmer" select e;
            return result;
        }
        ...
        {
            Emp maxSalary = Emps.OrderByDescending(e => e.Salary).First();
            IEnumerable<Emp> result = new List<Emp>()
            {
                maxSalary
            };
            return result;
        ...
        {
            IEnumerable<object> result = from e in Emps join d in Depts on e.Deptno equals d.Deptno select new
            {
                Ename = e.Ename,
                Job = e.Job,
                Deptno = d.Deptno
            };
            IEnumerable<object> result2 = Emps.Join(Depts, emp => emp.Deptno, dept => dept.Deptno, (emp, dept) => new
            {
        ...
        {
            bool result = Emps.Any(job => job.Job == "Backend Programmer");
            return result;
        }
        ...
        public static IEnumerable<object> Task10()
        {
            ...
            IEnumerable<object> result2 = Emps.Select(e => new
            {
                Ename = e.Ename,
                Job = e.Job,
                HireDate = e.HireDate
        ...
        {
            IEnumerable<object> result = Depts.GroupJoin(Emps, dept => dept.Deptno, emp => emp.Deptno, (dept, empd) => new
            {
                dept, empd
            }).Where(d=>d.empd.Count() > 1).Select(d => new
            {
                name = d.dept.Dname,
                numOfEmployees = d.empd.Count()
            });
            return result;
        }
        ...
        {
            int result = 0;
            result = arr.GroupBy(x => x).Where(y => y.Count() % 2 != 0).Select(z => z.Key).Single();
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            ...
            result = from dept in Depts
                ...
                where empdept.Count() == 5 || empdept.Count() == 0
                orderby dept.Dname
                select dept;
            return result;
        }
        ...
        public static IEnumerable<Object> Task15()
        {
            ...
            result = Emps.Where(e => e.Job.Contains('A')).GroupBy(e => e.Job).Where(g => g.Count() > 2)
                .OrderByDescending(g => g.Count()).Select(g => new { Praca = g.Key, LiczbaPracowników = g.Count() })
                .ToList();
            return result;
        }
        ...
        {
            IEnumerable<Object> result = null;
            result =from e in Emps join d in Depts on e.Deptno equals d.Deptno select new { e, d };
            return result;
        }
    }
